...
def load_colmap(data_dir="colmap_data"):
...
class Camera:
    def __init__(self, world_to_camera, intrinsic, distortion_params, image_size, image_file, camtype):
        # undistortion
        ...
        if len(distortion_params) == 0:
            ...
            mapx, mapy = cv2.initUndistortRectifyMap(
                intrinsic, distortion_params, None, intrinsic_undist, image_size, cv2.CV_32FC1)
            mask = None
